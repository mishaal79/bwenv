...
"#;
    ...
    fn test_search_response_parsing() {
        ...
        let exact_match = items
            .iter()
            .find(|item| item["name"].as_str() == Some("My Environment"));
...
"#;
    ...
    fn test_bitwarden_cli_version_parsing() {
        let version_outputs = vec!["1.25.1", "2.0.0-beta.1", "1.22.0"];
