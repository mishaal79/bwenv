...
mod tests {
    ...
    fn test_bitwarden_session_error() {
        ...
        assert_eq!(error.to_string(), format!("Bitwarden session error: {}", message));
    }
    ...
    fn test_env_file_read_error() {
        ...
        assert_eq!(error.to_string(), format!("Failed to read .env file: {}", message));
    }
    ...
    fn test_env_file_write_error() {
        ...
        assert_eq!(error.to_string(), format!("Failed to write .env file: {}", message));
    }
    ...
    fn test_env_file_format_error() {
        ...
        assert_eq!(error.to_string(), format!("Invalid .env file format: {}", message));
    }
    ...
    fn test_env_var_error() {
        ...
        assert_eq!(error.to_string(), format!("Environment variable error: {}", message));
    }
    ...
    fn test_item_not_found_error() {
        ...
        assert_eq!(error.to_string(), format!("Item not found in Bitwarden: {}", item_name));
    }
    ...
    fn test_folder_not_found_error() {
        ...
        assert_eq!(error.to_string(), format!("Folder not found in Bitwarden: {}", folder_name));
    }
    ...
    fn test_command_execution_error() {
        ...
        assert_eq!(error.to_string(), format!("Command execution failed: {}", message));
    }
    ...
    fn test_invalid_arguments_error() {
        ...
        assert_eq!(error.to_string(), format!("Invalid command arguments: {}", message));
    }
